...
class BottomNavBar extends StatelessWidget {
  ...
  const BottomNavBar({
    Key? key,   // ✅ Traditional way
    required this.currentIndex,
    required this.onTap,
  }) : super(key: key);   // ✅ Passing it to super
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(Icons.upload_file, "Ats_checker", 2), //navigate to ats_screen
          _buildNavItem(Icons.receipt_long, "Assessment", 3), //navigate to Assessment
