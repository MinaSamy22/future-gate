    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          ...
          const Text('Start Quiz?', style: TextStyle(fontSize: 22)),
        ],
      ),
      content: Column(
        ...
        children: [
          Text('You are about to start the "$quizTitle" quiz.',
              style: const TextStyle(fontSize: 16)),
          const SizedBox(height: 12),
          const Text('Important Notes:',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          const SizedBox(height: 8),
          Text('• Total questions: $totalQuestions', style: const TextStyle(fontSize: 14)),

          const Text('• You cannot exit once started', style: TextStyle(fontSize: 14)),
          const Text('• if you exit the quiz you will not be able to retake it again ', style: TextStyle(fontSize: 14, color: Colors.red,
          )),
